  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="rounded-base border-border relative w-full grow overflow-hidden border-2 bg-transparent data-[orientation=horizontal]:h-3 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-3"
      >
